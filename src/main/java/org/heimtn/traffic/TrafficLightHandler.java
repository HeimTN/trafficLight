...
/**
 * Основной класс по управлению светофорами, занимается созданием светофоров и событий(если таковые имеются)
 * На данный момент светофорам назначается рандомный id, но при необходимости можно прописать практически любое создание id.
 * Так же происходит рандомное обновление данных(пешеходы, машины), при необходимости так же можно прописать реальное считывание, например с БД.
 */
